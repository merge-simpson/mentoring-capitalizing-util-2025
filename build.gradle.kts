...
dependencies {
    ...
    testImplementation(kotlin("script-runtime")) // testImplementation("org.jetbrains.kotlin:kotlin-script-runtime:1.9.22")
...
publishing {
    publications {
        ...
        create<MavenPublication>("capitalizing-util") {
            from(components["java"]) // One of java, web, javaPlatform
            groupId = "com.github.merge-simpson" // github username required
            artifactId = "mentoring-capitalizing-util"
